...
/*
NOTE from Celestron:
The Celestron 8-9.25-11-14 focusers all use same 0.75mm thread pitch for the
focus shaft. The focus motor moves in 1000 steps per motor revolution Each motor
revolution moves the mirror 750 microns. Thus each step on the motor movement
moved the mirror .75 micron."
...
11" focuser: 750 microns/rev / (PULLEY_RATIO * MOTOR_SPR * MICROSTEP) = 0.5625 /
MICROSTEP

...
#define ML_GH                                                                                                                              \
    22            // Return 0xFF if the stepping mode is set to half-step otherwise returns                                                \
                  // 0x00
...
#define ML_SD                                                                                                                              \
    31               // Set the stepping delay (possible values are 02, 04, 08, 10 and 20 for a                                            \
                     // delay of respectively 250, 125, 63, 32, 16 step per second)
